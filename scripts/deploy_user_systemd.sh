...
PY
  ...
  _write_env_once "${APP_ENV_DIR}/backend.env" \
    ...
    "BLUEPRINT_HTTP_PROXY=${BLUEPRINT_HTTP_PROXY:-}" \
    "BLUEPRINT_HTTPS_PROXY=${BLUEPRINT_HTTPS_PROXY:-}" \
    "BLUEPRINT_NO_PROXY=${BLUEPRINT_NO_PROXY:-}" \
    "BLUEPRINT_REFERENCE_DOWNLOAD_TIMEOUT_S=${BLUEPRINT_REFERENCE_DOWNLOAD_TIMEOUT_S:-1800}" \
    "BLUEPRINT_REFERENCE_DOWNLOAD_RETRIES=${BLUEPRINT_REFERENCE_DOWNLOAD_RETRIES:-2}" \
...
MANAGER_HTTP_PROXY=${MANAGER_HTTP_PROXY:-${BLUEPRINT_HTTP_PROXY:-}}
MANAGER_HTTPS_PROXY=${MANAGER_HTTPS_PROXY:-${BLUEPRINT_HTTPS_PROXY:-}}
MANAGER_NO_PROXY=${MANAGER_NO_PROXY:-${BLUEPRINT_NO_PROXY:-}}
