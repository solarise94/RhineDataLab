...
check_unknown_blueprint_env_keys() {
  ...
  local known_keys=(
    ...
    BLUEPRINT_HTTP_PROXY
    BLUEPRINT_HTTPS_PROXY
    ...
    BLUEPRINT_REFERENCE_DOWNLOAD_RETRIES
    BLUEPRINT_REFERENCE_DOWNLOAD_TIMEOUT_S
...
write_env_line "${APP_ENV_DIR}/backend.env" BLUEPRINT_BWRAP_BIN "${BWRAP_BIN}"
...
write_env_line "${APP_ENV_DIR}/backend.env" BLUEPRINT_NO_PROXY "${BLUEPRINT_NO_PROXY:-}"
write_env_line "${APP_ENV_DIR}/backend.env" BLUEPRINT_REFERENCE_DOWNLOAD_TIMEOUT_S "${BLUEPRINT_REFERENCE_DOWNLOAD_TIMEOUT_S:-1800}"
write_env_line "${APP_ENV_DIR}/backend.env" BLUEPRINT_REFERENCE_DOWNLOAD_RETRIES "${BLUEPRINT_REFERENCE_DOWNLOAD_RETRIES:-2}"
...
write_env_line "${APP_ENV_DIR}/manager-agent.env" MANAGER_HTTP_PROXY "${MANAGER_HTTP_PROXY:-${BLUEPRINT_HTTP_PROXY:-}}"
write_env_line "${APP_ENV_DIR}/manager-agent.env" MANAGER_HTTPS_PROXY "${MANAGER_HTTPS_PROXY:-${BLUEPRINT_HTTPS_PROXY:-}}"
write_env_line "${APP_ENV_DIR}/manager-agent.env" MANAGER_NO_PROXY "${MANAGER_NO_PROXY:-${BLUEPRINT_NO_PROXY:-}}"
